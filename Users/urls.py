...
from Users.views import sign_up,sign_in,activate_user,admin_dashboard,assigned_role,create_group,group_list,sign_out,Sign_in,Sign_out,Profileview,ChangePassword,PasswordChangeDoneView,CustomPasswordReset,PasswordConfirmResetview,EditProfileView
urlpatterns = [
